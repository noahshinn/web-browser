...
pub fn parse_markdown_code_block(content: &str, language: Option<&str>) -> Result<String, ParseMarkdownCodeBlockError> {
...
pub fn parse_json_response<T: DeserializeOwned>(completion: &str) -> Result<T, ParseMarkdownCodeBlockError> {
